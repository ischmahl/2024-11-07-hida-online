...
venue: "Helmholtz Information & Data Science Academy (HIDA): Shell & Git Kickstart "       # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "Nov 7, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2024-11-07        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Aristotelis Misios", "Ines Schmahl"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Aristotelis Misios", "Ines Schmahl"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<p id="where">
  <strong>Where:</strong>
  <a href="https://helmholtz-de.zoom-x.de/j/65296549845?pwd=aqZvoF20LEdaaS1OmrKg3xzsKjvXlV.1">Zoom link</a>.
  {% if page.what3words %}
